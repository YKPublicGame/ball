function Canvas() {
    ...
    this.directionDown = function(event) {
    ...
    this.directionUp = function(event) {
    	var key = event.which || event.keyCode;
    ...
    this.newDirection = function(direction, list, isAddition) {
    	var result = false;
    	var found = false;
    ...
    this.updateTarget = function(list) {
    	this.target = { x : 0, y: 0 };
    ...
    this.touchInput = function(touch) {
