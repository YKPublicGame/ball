function ChatClient() {
    ...
    this.addChatLine = function(name, message, me) {
        if (this.mobile) {
            return;
        }
    ...
    this.addSystemLine = function(message) {
        if (this.mobile) {
            return;
        }
        var newline = document.createElement('li');
    ...
    this.appendMessage = function(node) {
        if (this.mobile) {
            return;
        }
    ...
    this.registerCommand = function(name, description, callback) {
        this.commands[name] = {
    ...
    this.toggleContinuity = function() {
    ...
    this.toggleRoundFood = function(args) {
